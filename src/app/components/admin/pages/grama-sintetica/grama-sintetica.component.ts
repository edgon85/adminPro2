...
@Component({
  selector: 'app-grama-sintetica',
  templateUrl: './grama-sintetica.component.html',
  styles: []
})
export class GramaSinteticaComponent implements OnInit {
  ...
  obtenerProductos() {
    this._productService.getAllProducts('grama sintetica').subscribe(resp => {
      this.productos = resp;
