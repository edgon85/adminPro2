...
@Component({
  selector: 'app-linoleo',
  templateUrl: './linoleo.component.html',
  styles: []
})
export class LinoleoComponent implements OnInit {
  ...
  obtenerProductos() {
    this._productService.getAllProducts('linoleo').subscribe(resp => {
      this.productos = resp;
