...
@Component({
  selector: 'app-papel-tapiz',
  templateUrl: './papel-tapiz.component.html',
  styles: []
})
export class PapelTapizComponent implements OnInit {
  ...
  obtenerProductos() {
    this._productService.getAllProducts('papel tapiz').subscribe(resp => {
      this.productos = resp;
